...
<div class="jumbotron text-center">
  <h2 data-toggle="modal" data-target="#exampleModalCenter">사원정보 ${sch.ename },${sch.deptno },
  ${sch.mgr },${sch.job }</h2>

</div> <!-- DeptCombo,MgrCombo,jobCombo -->
<div class="container">
   ...
   <table class="table table-hover table-striped">
    ...
    <tbody>
    	...
    	<tr><td>${emp.empno }</td><td>${emp.ename }</td><td>${emp.dname }</td>
    		<td>${emp.mgrname }</td><td>${emp.job }</td></tr>
    	</c:forEach>
    </tbody>
	</table>    
