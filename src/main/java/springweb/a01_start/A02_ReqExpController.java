...
public class A02_ReqExpController {
	...
	//http://localhost:8084/springweb/call02.do?age=25
	...
	//http://localhost:8084/springweb/call03.do?name=홍길동&age=25&loc=서울
	...
	//http://localhost:8084/springweb/call04.do?num01=30&num02=40
	//로그 창에 30+40 출력
	@RequestMapping("/call04.do")
	public String call04(
